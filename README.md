...
- 👩‍💻 Tech Lead @ **Google Developer Groups (GDG), SR Group of Institutions**
- 🤝 Contributor at **GirlScript Summer of Code (GSSoC) Extended 2024**
- 🔍 Cleared **CodeVita Round 1**
- 💼 Software Engineering Intern at **Accilives** and **CodSoft**
- 💡 Completed multiple real-world projects:
  - 🐾 **AdoptedTrails** – Pet Adoption Web Platform
  - 🕌 **Indian Heritage & Culture** – Digital Repository of Indian Culture
  - 🍽️ **Restaurant Website** – Menu, Booking & Reviews
  - 🛒 **Grocery Delivery Web App** – Blinkit-style platform
  - 🛍️ **E-commerce Website** – Product browsing, cart, payment features
